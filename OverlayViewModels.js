...
/// <amd-dependency path="../mva2/mva_files/overlayViewModel"/>
...
microsoft.learning.mlx.OverlayViewModels = (function () {
    ...
    obj.prototype = {
        ...
        Overlay_BusyloaderIndicatorViewModel: function () {
            var self = this;
        ...
        Overlay_WelcomeMessageViewModel: function () {
            var self = this;
            self.isShown = ko.observable(false);
        ...
        Overlay_CourseAddedViewModel: function () {
            var self = this;
            self.isShown = ko.observable(false);
