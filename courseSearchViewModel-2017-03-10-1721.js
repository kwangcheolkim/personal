...
microsoft.learning.mlx.OverlayViewModels = (function () {
    var obj = function OverlayViewModels() {
        var self = this;
        self.busyIndicator = new Overlay_BusyloaderIndicatorViewModel();
    };

    var busyIndicator = undefined,
        busyIndicatorMessage = undefined,
        welcomeMessage = undefined,
        courseAddMessage = undefined,
        coursePlayerOverlayModel = undefined,
        coursePlayerNotificationOverlayModel = undefined,
        notificationDialog = undefined,
        removedNotificationDialog = undefined,
        busyIndicatorMessageSupport = undefined,
        resignDialog = undefined,
        customMessage = undefined,
        errorDialog = undefined,
        confirmDialog = undefined,
        errorAuthDialog = undefined,
        retirementNotification = undefined;

    // Busy-Indicator view model
    function Overlay_BusyloaderIndicatorViewModel() {
        var self = this;

        self.isShown = ko.observable(false);
        self.message = ko.observable('');

        self.open = function (message, promise) {
            self.message(message);
            self.isShown(true);

            if (promise && promise.then) {
                promise.then(self.close, self.close);
            }
        };
    ...
    function Overlay_WelcomeMessageViewModel() {
        var self = this;
        self.isShown = ko.observable(false);
    ...
    function Overlay_CourseAddedViewModel() {
        var self = this;
        self.isShown = ko.observable(false);
    ...
    obj.prototype.GetBusyIndicator = function () {
        if (!busyIndicator) {
    ...
    obj.prototype.GetBusyIndicatorMessage = function () {
        if (!busyIndicatorMessage) {
            busyIndicatorMessage = new Overlay_BusyloaderIndicatorViewModel();
            if ($("#divAjaxloaderControl").get(0)) {
                ko.applyBindings(busyIndicatorMessage, $("#divAjaxloaderControl").get(0));
            }
        }
        return busyIndicatorMessage;
    };

    obj.prototype.GetBusyIndicatorMessageSupport = function () {
        if (!busyIndicatorMessageSupport) {
            busyIndicatorMessageSupport = new Overlay_BusyloaderIndicatorViewModel();
            if ($("#divAjaxloaderControlUnAuth").get(0)) {
                ko.applyBindings(busyIndicatorMessageSupport, $("#divAjaxloaderControlUnAuth").get(0));
            }
        }
        return busyIndicatorMessageSupport;
    };

    obj.prototype.GetWelcomeMessage = function () {
        if (!welcomeMessage) {
            welcomeMessage = new Overlay_WelcomeMessageViewModel();
            if ($("#divWelcomeMessage").get(0)) {
                ko.applyBindings(welcomeMessage, $("#divWelcomeMessage").get(0));
            }
        }
        return welcomeMessage;
    };

    obj.prototype.GetCourseAddOverlay = function () {
        if (!courseAddMessage) {
            courseAddMessage = new Overlay_CourseAddedViewModel();
    ...
    obj.prototype.GetCoursePlayerOverlay = function () {
        if (!coursePlayerOverlayModel) {
            var coursePlayerOverlayModel = new Overlay_BusyloaderIndicatorViewModel();
            if ($("#course-player-overlay").get(0)) {
                ko.applyBindings(coursePlayerOverlayModel, $("#course-player-overlay").get(0));
            }
        }

        return coursePlayerOverlayModel;
    };

    obj.prototype.GetCoursePlayerNotificationOverlay = function (messageHeading, btnText) {
    ...
    obj.prototype.GetNotification = function (notificationMessage, btnText) {
    ...
    obj.prototype.GetRemovedNotification = function (notificationMessage, btnText) {
    ...
    obj.prototype.GetRetirementNotification = function (notificationMessage, infoMsg, btnPrimaryText, btnTertiaryText, replacementCourseData) {
    ...
    obj.prototype.GetDeleteConfirmation = function (errorArray, headingText, btnText, btnCancelText) {
    ...
    obj.prototype.GetErrors = function (errorArray, headingText, btnText, btnCancelText) {
        if (!errorDialog) {
    ...
    obj.prototype.GetAuthError = function (errorArray, headingText, btnText, btnCancelText) {
        if (!errorAuthDialog) {
    ...
    obj.prototype.registerSearchCallbacks = function (showMyCourses, showCourse) {
        this.showMyCourses = showMyCourses;
        this.showCourse = showCourse;
    };

    obj.prototype.GetResigningOverlay = function (url) {
        if (!resignDialog) {
    ...
    function Overlay_ResigningViewModel(url) {
        var self = this;
        self.isShown = ko.observable(false);
    ...
    function Overlay_NotificationViewModel(notificationMessage, btnText, overlay) {
        var self = this;
        self.isShown = ko.observable(false);
    ...
    function Overlay_RetirementNotificationViewModel(notificationMessage, infoMsg, btnPrimaryText, btnTertiaryText, replacementCourseData) {
        var self = this;
        self.isShown = ko.observable(false);
        self.notification = ko.observable(notificationMessage);
    ...
    obj.prototype.GetCustomMessage = function () {
        if (!customMessage) {
    ...
    function Overlay_CustomMessageViewModel() {
        var self = this;
    ...
    function Overlay_ErrorViewModel(errorArray, headingText, btnText, btnCancelText) {
        var self = this
        deferred = $.Deferred();
        self.isShown = ko.observable(false);
...
//
// END OverlayViewModels.js
//

$(function () {
    CourseSearchViewModel = (function () {
